...
(define tests
  (test-suite
   ...
   (check-equal? (list-nth-mod (list 0 1 2 3 4) 10) 0 "list-nth-mod test 3")
   (check-equal? (list-nth-mod (list 0 1 2 3 4) 6) 1 "list-nth-mod test 4")
   (check-exn exn:fail? (lambda () (list-nth-mod (list 0 1 2 3 4) -1)) "list-nth-mod: negative number")
   (check-exn exn:fail? (lambda () (list-nth-mod null 6)) "list-nth-mod: empty list")
   ;(check-equal? (list-nth-mod (list 0 1 2 3 4) -1) (error "list-nth-mod: negative number") "list-nth-mod test 5")
   ;(check-equal? (list-nth-mod null 6) (error "list-nth-mod: empty list") "list-nth-mod test 6")
   ...
   (check-equal? (stream-for-n-steps (stream-add-zero powers-of-two) 3) (list (cons 0 2)(cons 0 4)(cons 0 8)) "stream-add-zero test 2")
   ...
   (check-equal? ((cached-assoc (list (cons 1 2) (cons 3 4)) 3) 2) #f "cached-assoc test 2")
   (check-equal? ((cached-assoc (list (cons "a" "b") (cons 3 4) (cons 9 4) (cons #t #f) (cons 5 6)) 6) #t) (cons #t #f) "cached-assoc test 3")
